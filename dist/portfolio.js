...
exports.project = exports.contactPageData = exports.publicationsHeader = exports.projectsHeader = exports.experience = exports.certifications = exports.degrees = exports.competitiveSites = exports.skills = exports.socialMediaLinks = exports.greeting = exports.seo = exports.settings = exports.pathNavigation = void 0;
...
const greeting = {
    ...
    portfolio_repository: "https://github.com/rahuldand/HRMS-BACKEND",
    githubProfile: "https://github.com/dashboard",
};
...
const socialMediaLinks = [
    ...
    {
        name: "Github",
        link: "https://github.com/rahuldand",
...
exports.competitiveSites = competitiveSites;
const degrees = {
    degree: [
        {
...
const certifications = {
    ...
    certifications: [
        ...
        // },
        {
            ...
            subtitle: "",
            logo_path: "Masai.png",
            certificate_link: "https://drive.google.com/file/d/1HGchSoEpLXsM5b8HVLkOLWHOAQwvNpRw/view?usp=sharing",
            alt_name: "MASAI SCHOOL",
            color_code: "#2A73CC",
        },
        // {
...
const experience = {
    ...
    description: "I've worked with startups, mainly in SDE roles in Product based Company's. I'm interested in exploring different fields in IT, related to newly required technology's",
            ...
            experiences: [
                {
                    ...
                    description: "I am working on a project called PageBuilder, which is powered by Honebi. In this project, i had primarily focused on using state management tools like Redux. The main purpose of PageBuilder is to create various types of websites based on customer requests.",
                    color: "#0879bf",
                },
                // {
...
const projectsHeader = {
    title: "Projects",
    description: "I create front-end Projects, deploying them as web apps with cloud tech. Prioritizing security and performance, I emphasize documentation, testing, and automation. Feedback-driven and organized, I'm dedicated to continuous learning for project excellence. ❣️",
    avatar_image_path: "projects.png",
};
exports.projectsHeader = projectsHeader;
const publicationsHeader = {
    title: "Publications",
    description: "I have worked on and published a few research papers and publications of my own.",
    avatar_image_path: "projects_image.svg",
};
exports.publicationsHeader = publicationsHeader;
// projects
const project = {
    data: [
        {
...
const contactPageData = {
    contactSection: {
        ...
        description: "I'm dedicated to helping people become better through knowledge. I create lessons that are carefully designed to touch each person personally, so they can change and improve who they are. My main aim is to inspire long-lasting and meaningful changes in everyone who reads what I write.",
    },
    blogSection: {
        title: "Blogs",
        subtitle: "I enjoy writing lessons that can empower people on a personal level. These lessons are meant to deeply affect each reader and help them change and grow as a person. My main aim is to inspire meaningful and lasting changes in anyone who reads my work.",
...
exports.contactPageData = contactPageData;
exports.pathNavigation = [
